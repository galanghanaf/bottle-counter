            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <center>
                            <br>
                            <a href="<?php echo base_url('admin/inputsupervisor') ?>" style="float:left" class="previous btn button3 btn-primary"><i class="fas fa-arrow-left"></i></a>
                            <div class="d-inline">
                            ...
                            <div class="card-body w-75">
                                <?php foreach ($data_supervisor as $row) : ?>
                                    <?php echo form_open_multipart('admin/editsupervisoraksi') ?>
                                    <div class="form-group">
                                        <input hidden type="text" name="id" id="id" class="form-control form-control-lg" value="<?php echo $row->id ?>">

                                        <input hidden type="text" name="date_created" id="date_created" class="form-control form-control-lg" value="<?php echo $row->date_created ?>">


                                        <input autofocus type="text" name="name" id="name" class="form-control form-control-lg" placeholder="Masukan Nama" value="<?php echo $row->name ?>">
                                        <?= form_error('name', '<small class="text-danger">', '</small>') ?>
                                    </div>

                                    <button onclick="return confirm('Konfirmasi Untuk Mengubah Data Supervisor')" type="submit" class="btn btn-success font-weight-bold btn-lg">SIMPAN</button>
                                    <?php echo form_close(); ?>
                                <?php endforeach; ?>
                            </div>
                        </center>
