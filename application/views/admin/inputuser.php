            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <center>
                            ...
                            <div class="d-inline">
                                ...
                                <a href="<?php echo base_url('admin/inputuser') ?>" class="btn btn-primary font-weight-bold mb-3 btn-md">Refresh</a>
                            ...
                            <div class="card-body w-75">
                                ...
                                <form method="post" action="<?= base_url('admin/inputuser'); ?>">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="email" id="email" class="form-control form-control-lg" placeholder="Email Address" value="<?= set_value('email'); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="password" name="password2" id="password2" class="form-control form-control-lg" placeholder="Ulangi Password">
                    ...
                    <center>
                        ...
                        <a class="mb-2 btn btn-primary float-left font-weight-bold" href="<?php echo base_url('admin/exportuser') ?>">
                                ...
                                <tbody>
                                    ...
                                    foreach ($data_user as $row) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                                    <a class="btn btn-sm btn-warning" href="<?php echo base_url('admin/edituser/' . $row->id) ?>">
                                            ...
                                            <td>
                                                <center>
                                                    ...
                                                    <?php } elseif ($row->role_id == '2') { ?>
                                                        <a onclick="return confirm('Konfirmasi Penghapusan Data')" class="btn btn-sm btn-danger" href="<?php echo base_url('admin/deleteuser/' . $row->id) ?>">
