            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <center>
                            <br>
                            <a href="<?php echo base_url('user/myprofile') ?>" style="float:left" class="previous btn button3 btn-primary"><i class="fas fa-arrow-left"></i></a>
                            <div class="d-inline">
                            ...
                            <div class="card-body w-75">
                                <br>
                                <form method="post" action="<?= base_url('user/editmyprofile'); ?>">
