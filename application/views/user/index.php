            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                <a class="dropdown-item btn btn-xl" href="<?php echo base_url('user/myprofile') ?>">
                ...
                <div class="container-fluid">
                    ...
                    <center>
                        <br>
                        <div class="d-inline">
                            <a href="<?php echo base_url('user/index') ?>" class="btn btn-primary font-weight-bold mb-3 btn-md">Refresh Data Botol</a>
                        </div>
                        <br>
                        <br>
                        <h1 class="h1 mb-0 text-gray-800 font-weight-bold text-center"><?php echo $title ?> <b class="text-primary">HOD</b></h1>
                        <br>
                        <a class="btn btn-success font-weight-bold btn-lg" style="border-radius: 7px;" href="<?php echo base_url('user/inputbotol') ?>">Input Data Botol</a>
                    </center>
                    <br>
                    <br>
                    ...
                    <div class="d-inline">
                        <a class="mb-2 btn btn-primary float-left font-weight-bold" href="<?php echo base_url('user/exportbotol') ?>">
