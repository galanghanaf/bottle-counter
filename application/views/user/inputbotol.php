                        ...
                        <div class="card">
                            <div class="card-body" style=" background-color: #8791a5;">
                                ...
                                <div class="card-body" style="color: white;">
                                    <form method="post" action="<?php echo base_url('user/inputbotol') ?>">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group">
                                                <div class="wrapper1">
                                                    <div class="container1">
                                                        ...
                                                        <a class="btn btn-sm btn-light mb-3 font-weight-bold" href="<?php echo base_url('user/inputbotol') ?>" data-toggle="modal" data-target="#satuModal"><i class="fas fa-pen-square"></i> Custom</a>
                                                    ...
                                                    <div class="container2">
                                                        ...
                                                        <a class="btn btn-sm btn-light mb-3 font-weight-bold" href="<?php echo base_url('user/inputbotol') ?>" data-toggle="modal" data-target="#duaModal"><i class="fas fa-pen-square"></i> Custom</a>
                                                    ...
                                                    <div class="container3">
                                                        ...
                                                        <a class="btn btn-sm btn-light mb-3 font-weight-bold" href="<?php echo base_url('user/inputbotol') ?>" data-toggle="modal" data-target="#tigaModal"><i class="fas fa-pen-square"></i> Custom</a>
                                                    ...
                                                    <div class="container4">
                                                        ...
                                                        <a class="btn btn-sm btn-light mb-3 font-weight-bold" href="<?php echo base_url('user/inputbotol') ?>" data-toggle="modal" data-target="#empatModal"><i class="fas fa-pen-square"></i> Custom</a>
