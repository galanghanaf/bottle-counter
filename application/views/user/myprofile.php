            ...
            <div id="content">
                ...
                <div class="container-fluid ">
                    ...
                    <div class="container py-5">
                        <!-- Page Heading -->
                        <div class="d-inline">
                            <a href="<?php echo base_url('user/index') ?>" style="float:left; margin-left:70px" class="previous btn button3 btn-primary"><i class="fas fa-arrow-left"></i></a>
                            ...
                            <div class="col-lg">
                                <div class="card mb-4">
                                    <div class="card-body text-center">
                                        <a href="<?= base_url('user/editmyprofile') ?>"><img class="img-profile rounded-circle" src="<?= base_url('assets/img/profile/') . $user['image']; ?>" style="width: 120px; height: 120px;"></a>



                                        <div class="d-flex justify-content-center mb-2">
                                            <a class="btn btn-primary mt-2" href="<?= base_url('user/editmyprofile') ?>">
